                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="established_year" class="form-control" value="{{ $company->established_year ?? '' }}">
                        </div>
                        <div class="mb-3">
                            <label><strong>Number of Employees:</strong></label>
                            <input type="number" name="employees_count" class="form-control" value="{{ $company->employees_count ?? '' }}">
                        </div>
                        <div class="mb-3">
