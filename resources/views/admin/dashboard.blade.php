            ...
            <div class="col-lg-12">
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-gradient-primary text-white">
                        <h3 class="card-title font-weight-bold"><i class="fas fa-chart-line"></i> Company Growth Overview</h3>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-lg rounded-lg text-center p-3 bg-light">
                    <div class="card-body">
                        ...
                        <a href="{{route('admin.employee.index')}}" class="btn btn-outline-primary btn-sm">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-lg rounded-lg text-center p-3 bg-light">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.company.profile') }}" class="btn btn-outline-success btn-sm">View Details</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-lg rounded-lg text-center p-3 bg-light">
                    <div class="card-body">
                        ...
                        <a href="{{ route('admin.branches.index') }}" class="btn btn-outline-warning btn-sm">View Details</a>
                    </div>
                </div>
            </div>
