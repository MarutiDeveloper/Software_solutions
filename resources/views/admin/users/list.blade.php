        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('users.create') }}" class="btn btn-primary">Create New Employee</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                                            ...
                                            @elseif ($user->status === 'Suspended')
                                                <!-- <span class="badge bg-warning text-dark">
                                                    <svg class="h-6 w-6 text-dark" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            d="M12 9v3m0 3h.01m-6-6a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                                    </svg> -->
                                                    <strong style=" color: #ff5733;">Suspended</strong>
                                                </span>
