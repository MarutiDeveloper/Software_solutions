...
<div class="container mt-5">
    ...
    <div class="mb-3">
        <a href="{{ route('admin.create_company.create') }}" class="btn btn-primary">
            ...
            <tbody>
                @forelse($allCompanyInfo as $contact) <!-- Loop through the records -->
                    <tr>
                        ...
                        <td>
                            <!-- Edit button -->
                            <a href="{{ route('admin.create_company.edit', $contact->id) }}" 
                               class="btn btn-warning btn-sm me-2">
                                <i class="fas fa-edit"></i> Edit
                            </a>

                            <!-- Delete form -->
                            <form action="{{ route('admin.create_company.destroy', $contact->id) }}" 
